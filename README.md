...
Session Forge orchestrates LLM-assisted development sessions across fleets of machines. It combines SSH, git worktrees, and tmux automation into a single CLI (`sf`) plus an optional FastAPI server. With a five-minute onboarding flow, you can install the CLI, bootstrap your hosts, and launch the first Claude or Codex CLI session tied to a feature branch.
...
| `sf bootstrap --hosts ...` | Check git/tmux/LLM CLIs on hosts |
